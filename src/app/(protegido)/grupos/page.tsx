...
import { Plus, Search, Users, Globe, Lock, ChevronRight, RefreshCw, WifiOff, Star } from 'lucide-react';
...
function CardGrupoSimples({ grupo, ehFavorito, mostrarEstrela, onDefinirFavorito }: Readonly<{ grupo: Grupo; ehFavorito?: boolean; mostrarEstrela?: boolean; onDefinirFavorito?: (grupoId: string) => void }>) {
  const router = useRouter();
  ...
  return (
    <div className="relative">
      ...
      {/* Estrela de favorito — posicionada no canto superior direito */}
